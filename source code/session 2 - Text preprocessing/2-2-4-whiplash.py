...
# open 함수를 통해 'result-1-3-5-whiplash.txt' 파일을 열고 이를 f로 지정한다
with open('result-1-3-5-whiplash.txt', 'r', encoding = 'utf-8') as f:			# 읽기 형식('r')로 지정하고 인코딩은 'utf-8'로 설정한다
...
# open 함수를 통해 'result-2-2-4-whiplash.txt' 파일을 열고 이를 f로 지정한다
with open('result-2-2-4-whiplash.txt', 'w', encoding = 'utf-8') as f:		# 쓰기 형식('w')로 지정하고 인코딩은 'utf-8'로 설정한다
